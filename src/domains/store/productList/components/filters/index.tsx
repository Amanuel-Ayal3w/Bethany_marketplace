...
const Filters = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "lg:min-w-[220px] w-[310px] ease-bethany-easeOut transition-all pb-8 duration-500 lg:w-auto max-w-[260px] absolute lg:relative h-full px-5 border-r bg-white lg:z-1 z-20 border-gray-300 overflow-y-scroll",
      ...
      >
        ...
        <Button
          ...
          className="w-full py-1 text-sm rounded-md text-gray-100 border-none bg-bethany-blue-500 hover:bg-bethany-blue-600 active:bg-bethany-blue-400 disabled:bg-bethany-blue-700"
